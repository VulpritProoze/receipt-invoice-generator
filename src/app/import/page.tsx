    ...
    <Container>
      <div className="mb-6">
        ...
        <p className="mt-2 text-gray-600">
          Upload a CSV or XLSX file containing your billing history to create invoice items.
        </p>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
        ...
        <div className="text-sm text-blue-800 space-y-2">
          ...
          <ul className="list-disc list-inside ml-4 space-y-1">
            ...
            <li><strong>Quantity</strong> — Quantity as a whole number (required)</li>
            <li><strong>Rate</strong> — Rate per unit as a decimal (required)</li>
