 ...
 * Key format: invoice:[userID]:[invoiceID]
 * Sequence counter: invoice:sequence:[userID]
 */
...
/**
 * Create a standalone invoice item in Redis.
 * Used for importing billing history before invoices are generated.
 * Key format: invoiceItem:[userID]:[itemID]
 */
