...
export async function getCompanyConfig(
  ...
  const stmt = db.prepare(`
    SELECT brand_name as brandName, company_name as companyName, company_url as companyUrl, address_line as addressLine, postal_address as postalAddress, country, logo_url as logoUrl
